...
export class ApidataComponent implements OnInit {
  ...
  //this.service.getDataWithConcatMap([1,2,3]).subscribe(res=>console.log(res));  
  //this.service.getDataWithMergeMap([1,2,3]).subscribe(res=>console.log(res));  
  //this.service.getDataWithForkJoin([1,2,3]).subscribe(res=>console.log(res));
  this.service.getDataWithSwitchMap([1,2,3]).subscribe(res=>console.log(res));
  }
